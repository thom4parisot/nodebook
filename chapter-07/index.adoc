...
Nous avons allégé le fichier `server.js` et rendu lisible les points importants
...
db en param
prob c'est qu'on initialise la db différemment
un des moyens c'est de tester une ou plusieurs routes <<tests.frontend>>
