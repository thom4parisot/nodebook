...
cours d'exécution et vous avez remarqué que le résultat ne changeait pas ?
...
----
<1> Nous déplaçons la configuration et la connexion à la base de données dans son propre module.
