...
programmes qui aident à automatiser des actions
outillage pour ses applications
interfaces visuelles (dans un terminal -- potentiel à être partagé sur une appli web)
modules redistribuables
////
