...
Le potentiel de combinaison de ces éléments entre eux est gigantesque.
...
cambouis.
Les différents choix peuvent se créer dynamiquement, à partir de données
obtenues depuis une ressource distante — ils n'ont pas à être écrits en dur
dans le code.
