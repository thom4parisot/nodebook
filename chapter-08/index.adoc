...
[[tests]]
== Vers un code réutilisable et testable
indexterm:[application en ligne de commande, test]
indexterm:[application en ligne de commande, modularité]
...
indexterm:[application en ligne de commande, test, assertion]
