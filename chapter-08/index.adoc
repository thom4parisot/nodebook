...
glob
faire attention au cwd : attente c'est par rapport où se trouve l'utilisateur
cwd + absolu ou cwd + relatif = c'est pour les fichiers donnés par les utilisateurs
__dirname : c'est pour les fichiers sources (naviguer depuis le script courant)
