...
L'existence de Node et du registre _npm_ a favorisé le développement d'un
...
Les _presets_ des modules _npm_ faisant office de groupes logiques.
...
Nous avons vu comment <<../chapter-05/index.adoc#modules,charger des modules _npm_>>
dans le chapitre 5.
...
mais aussi pour faire le lien avec les modules _npm_ :
...
- _browserify_ pour l'intégration avec les modules _npm_.
...
inclure des modules _npm_ dans les navigateurs web.
...
<<browserify,browserify>> évoqués ci-avant – Node regorge de modules _npm_
...
les modules _npm_ `karma-browserify`, `karma-mocha` et `karma-fixture` :
...
Le recours aux modules _npm_ combinés aux modules _ECMAScript_ facilite le
