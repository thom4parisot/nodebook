...
L'existence de Node et du registre _npm_ a favorisé le développement d'un écosystème orienté _frontend_ plus simple à appréhender.
...
dans le chapitre 5.
Intéressons-nous à leur utilisation dans le contexte d'une application frontend.
