...
La popularité de Node s'est établie également pour la profusion d'outillage apportée au développement web _front-end_.

Ce chapitre nous apprendra le rôle de Node en tant qu'extension au développement _front-end_.
