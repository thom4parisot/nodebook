...
====
Toutes les options de configuration sont documentées sur le site officiel de _babel_.
Une autre page explique où placer et quoi mettre dans les fichiers `.babelrc.yml`.
...
====
_polyfill.io_ possède une documentation très complète.
...
====
De bons usages des _polyfills_ ainsi les risques liés à leur utilisation sont compilés dans un guide édité par le W3C.
...
La faute n'est pas vraiment celle de _jQuery_ mais plutôt la nôtre — enfin, la _mienne_ icon:smile-o[].
...
<<../chapter-06/index.adoc#deploy.ci,service d'intégration continue>>, par exemple.
