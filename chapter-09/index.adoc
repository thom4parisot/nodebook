...
Chacune d'entre elles ciblent une fonctionnalité spécifique d'une version d'_ECMAScript_.
...
Le résultat est retourné sous forme de _promesse_ (voir la <<../chapter-03/index.adoc#primitive-promise,section _Promise_>> du Chapitre 3).
...
<3> Appel réel de la fonction `getLinkElementContent`, résolu comme une <<../chapter-03/index.adoc#primitive-promise,promesse>> et dont nous testons le résultat à la ligne suivante ;
