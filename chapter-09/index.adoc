...
Nous avons vu comment <<../chapter-04/index.adoc#api-require,charger des modules _npm_>> dans le Chapitre 4.
...
<4> La variable d'environnement `MOZ_HEADLESS` indique à Firefox de
démarrer sans afficher d'interface graphique à l'écran
