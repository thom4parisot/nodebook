...
Ces différentes techniques de minification chercherons l'intégrité de vos programmes.
Les mainteneurs des outils de compression mettent en général en garde si une option est possible destructrice ou non.
