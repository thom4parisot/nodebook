...
dont nous décrirons le fonctionnement dans la section suivante — <<process,comprendre la notion de processus>>.
...
Ce _processus_ existe pendant toute la durée de vie du script
et s'arrête en cas d'erreur ou lorqu'il n'y a plus d'opérations à effectuer.
