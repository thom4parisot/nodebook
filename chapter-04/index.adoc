...
Le fichier d'exemple `modules/enfant.js` contient une variable.
...
=== La variable globale `window`

y'en n'a pas, et donc pas de window.document, etc.

à la place y'a `global`

Cf. https://nodejs.org/docs/latest-v8.x/api/globals.html
