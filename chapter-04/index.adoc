...
L'objet global `console` est très souvent utilisé dans le milieu du web
pour ses fonctions `console.log` et `console.error`.
...
[TIP]
.[RemarquePreTitre]#API# La classe `Console`
====
La variable globale `console` est une
