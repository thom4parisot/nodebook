...
C'est d'autant plus pratique quand on n'a pas la maîtrise du
...
En maîtrisant les flux standards, on peut *créer des programmes modulaires*
...
Enfin, plusieurs *problèmes* peuvent apparaître lors du chargement d'un module :
