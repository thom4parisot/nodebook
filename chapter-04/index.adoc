...
Les _scripts_ sont alors à invoquer manuellement, sur un _crochet git_ (_git hook_) ou automatiquement lors du déploiement avec un <<../chapter-07/index.adoc#ci,service d'intégration continue>>, par exemple.
