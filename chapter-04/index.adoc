...
Il faut encore _typer_ les ressources renvoyées afin qu'elles soient comprises
...
----
<1> Chaque afflux de données appelle notre fonction en lui fournissant un seul paramètre contenant les données en question.
