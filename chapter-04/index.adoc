...
Le terminal est un autre programme pour dialoguer avec
...
[[repl]]
=== Avec l'invite de commande interactive (REPL)

L'invite de commande interactive est un moyen de parler
...
====
La touche kbd:[TAB] affiche _toutes_ les variables connues
...
====
La variable{nbsp}``\_`` est spécifique à l'invite de commande Node.
...
de _propriétés_ et de _fonctions_.
