...
L'erreur textuelle explicite que le fichier n'existe pas.
...
sinon ça renvoie un `process.on('uncaughtException')`
...
notre code est bon mais notre demande est rejetée
vaut pour le réseau, accès aux fichiers
parfois pas grave du tout
