...
Node embarque d'autres modules avancés pour aller plus loin.
Ils nécessitent avant tout des connaissances plus bas niveau (et proche des protocoles)
que celles liées au développement d'applications web.
