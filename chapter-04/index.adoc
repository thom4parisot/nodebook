...
Est-ce que n'est pas grave et on passe à la suite ?
Ou peut-être que ce fichier était censé exister et qu'un traitement particulier
doit être fait, comme notifier l'équipe de maintenance _et_ afficher une page
d'erreur côté utilisateur.
...
sinon plantage et `process.on('unhandledRejection')`
