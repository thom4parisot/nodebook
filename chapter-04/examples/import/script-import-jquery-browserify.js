 ...
 */
                    ...
                    (function add(args) {
                      jQuery.each(args, function(_, arg) {
                        if (jQuery.isFunction(arg)) {
                          ...
                          arg && arg.length && jQuery.type(arg) !== 'string'
                        ) {
                          // Inspect recursively
                          add(arg);
                        }
          ...
          (function() {
            ...
            support.noCloneChecked = !!div.cloneNode(
              true,
          ...
          function ajaxExtend(target, src) {
            ...
            for (key in src) {
              if (src[key] !== undefined) {
                (flatOptions[key] ? target : deep || (deep = {}))[key] = src[
                  key
                ];
              }
            }
