...
_npm, Inc_ est une entreprise privée fondée en janvier 2014 par Isaacs Schlueter dans le but de fournir des solutions professionnelles se basant sur `npm`.
...
Cette annonce n'a pas d'impact sur la libre utilisation du code source de Node, régi par la _licence MIT_.
