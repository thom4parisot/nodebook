...
L'interpréteur crée un environnement d'exécution, initialise la boucle évènementielle (_EventLoop_, voir ci-après), lit le code JavaScript, crée l'arbre de dépendance des modules puis demande à exécuter le tout. +
