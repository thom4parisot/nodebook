...
L'opérateur `typeof` permet d'identifier une date :

[source,javascript]
----
typeof (new Date('2014-03-24')); <1>
typeof (new Date('2014-03-24 13:37')); <1>
typeof Date.parse('2014-03-24 13:37'); <2>
----
<1> Retourne `'date'` ;
<2> Retourne `'number'`, car il s'agit d'une date exprimée en millisecondes depuis le 1er janvier 1970 (temps _EPOCH_).
