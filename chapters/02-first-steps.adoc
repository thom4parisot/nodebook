...
- `node votre-script.js` invoquera le dit script et s'arrêtera dès qu'il n'y aura plus de code en attente dans l'_Event Loop_.
...
=== Mon premier script Node.js : sauvegarder une page Web
