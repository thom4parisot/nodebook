...
Il se sert du contexte disponible pour offrir une auto-complétion et des bulles d'aide pertinentes. Grâce à des fonctionnalités natives comme l'exécution, le débogage, la gestion de tâches et le versionnement, c'est un éditeur parfaitement adapté au développemnt d'applications Node.
