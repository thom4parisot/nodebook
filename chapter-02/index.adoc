...
image::images/node-on-windows.png[align="center",scaledwidth="85%"]
...
Des binaires et installeurs sont de ce fait disponibles pour Raspberry Pi, à base de processeur _ARM_, entre autre.
...
Lorsqu'un système d'exploitation est en état de marche, différents programmes fonctionnent pour fournir différents servives : transmission du son, affichage vidéo, coordination des processus et de leurs ressources etc.
...
image::images/unix-env.png[align="center",scaledwidth="85%"]
...
image::images/process-title.png[align="center",scaledwidth="85%"]
