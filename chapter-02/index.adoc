...
:es: ECMAScript 5
:esNext: ECMAScript 6
:sourceDir: ../../examples/nodebook.chapter-02/src
:revisionYear: 2014
...
image::{indir}/images/terminal.png[align="center",scaledwidth="85%"]
...
----
wget http://nodejs.org/dist/latest/node-v0.10.30.tar.gz
...
image::{indir}/images/webstorm.png[align="center",scaledwidth="85%"]
...
image::{indir}/images/node-repl.png[align="center",scaledwidth="85%"]
...
image::{indir}/images/node-exec.png[align="center",scaledwidth="85%"]
...
Autant de problèmes dont nous n'avons pas nécessairement envie de nous soucier mais que l'on aimerait pour autant éviter. _
...
.Résultat final
image::{indir}/images/print-csv-cli.png[align="center",scaledwidth="85%"]
