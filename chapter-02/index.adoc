...
[WARNING]
====
Partie en cours de réécriture pour refléter les évolutions d'ES2015 — notamment les _arrow functions_.
====
...
[WARNING]
====
Partie en cours de réécriture pour refléter les évolutions d'ES2015 — notamment `Object.assign` et _destructuring_.
====
...
Et si `Object.keys` extrait les clés d'un objet, l'opérateur `for..of` permet désormais d'itérer dessus, sans inclure les propriétés (à l'instar de `Object.getOwnKeys()`) :

[source,javascript]
.primitives-object-keys-for-of.js
----
include::{sourceDir}/primitives-object-keys-for-of.js[]
----
<1> Affiche `[ 'name', 'services' ]` ;
<2> Affiche successivement `name` puis `services`.
...
[WARNING]
====
Partie en cours de réécriture pour refléter les évolutions d'ES2015. — extends
====
 :
...
ECMAScript permet de définir des accesseurs sur les propriétés de votre choix ; dans l'exemple suivant, la propriété `EAN13` :
