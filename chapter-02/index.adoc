...
----
include::{sourceDir}/primitive-object-advanced.js[]
----
...
- elles peuvent être créées à partir d'un <<primitive-iterable,itérable>> ou d'un tableau (de valeurs ou de clés+valeurs).

[source,javascript]
.primitive-set.js
----
include::{sourceDir}/primitive-set.js[]
----
...
.primitive-map.js
----
include::{sourceDir}/primitive-map.js[]
----
...
----
$ chmod +x src/print-args
$ ./src/print-args Affiche moi
[ 'Affiche', 'moi' ]
----
