...
Vous en apprendrez davantage sur diverses opérations de routine de vos applications dans le <<../chapter-05/index.adoc,chapitre 5>>, notamment la <<../chapter-05/index.adoc#npm-outdated,vérification de l'état des dépendances>>.
