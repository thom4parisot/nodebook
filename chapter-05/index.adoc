...
['un']
$ npm run print-args <i>--</i> un --test=true
['un', '--test=true']
----
====
...
La longueur des commandes rend la lecture difficile assez rapidement.
Les commandes deviennent liées et indissociables.
