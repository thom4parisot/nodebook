...
En pratique, les fonctionnalités qui donnent "de l'avance" à _yarn_
sont régulièrement rattrapées par npm.

Faites-vous une idée, essayez _yarn_.
Gardez-le pour les bonnes raisons et pas parce que le ou la voisin·e
du coworking vous chambre parce que vous n'êtes soit-disant pas à jour.
