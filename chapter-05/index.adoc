...
Étudions la mise à jour de `lodash@2.2.0` vers :

- `lodash@2.2.1` : mise à jour patch — des bugs sont corrigés ;
- `lodash@2.4.2` : mise à jour mineure — des fonctionnalités sont ajoutées,
corrigées ou modifiées et ce, sans affecter notre code ;
- `lodash@{lodashVersion}` : mise à jour majeure — des fonctionnalités ont
été modifiées, remaniées ou supprimées et peuvent casser notre code qui repose dessus.

La mise à jour majeure demande de bien lire la documentation du module
