...
_sanitize-filename_ ([URL]#https://npmjs.com/sanitize-filename#).

=== helmet

_helmet_ ([URL]#https://npmjs.com/helmet#).

=== dompurify

_dompurify_ ([URL]#https://npmjs.com/dompurify#).

=== filenamify

_filenamify_ ([URL]#https://npmjs.com/filenamify#).
...
_svgo_ ([URL]#https://www.npmjs.com/svgo#).
...
.browserify.js
----
include::{sourceDir}/browserify.js[]
----
<1> Affiche `Open Sky`.
...
----
$ browserify browserify.js -o browserify.bundle.js
----

Inclus dans un navigateur Web, le fichier `browserify.bundle.js` affichera
...
_sequelize_ ([URL]#https://npmjs.com/sequelize#).
...
_yargs-parser_ ([URL]#https://npmjs.com/yargs-parser#).

=== args

_args_ ([URL]#https://npmjs.com/args#).

=== caporal

_caporal_ ([URL]#https://npmjs.com/caporal#).

=== promptly

_promptly_ ([URL]#https://npmjs.com/promptly#).

=== supports-color

_supports-color_ ([URL]#https://npmjs.com/supports-color#).
...
_fastify_ ([URL]#https://npmjs.com/fastify#).


_point-of-view_ ([URL]#https://npmjs.com/point-of-view#).
...
Il utilise WebSocket, Ajax ou JSON-P selon les capacités du client, notamment
les navigateurs anciens qui ne supportent pas WebSocket.
...
_swagger-client_ ([URL]#https://npmjs.com/swagger-client#).

=== elasticsearch

_elasticsearch_ ([URL]#https://npmjs.com/elasticsearch#).
