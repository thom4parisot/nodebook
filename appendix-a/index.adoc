...
<2> Affiche `.....sshid_rsa` — les caractères `/` ont été nettoyés car il permettrait de créer des chemins compromettant pour l'application ou le système d'exploitation.
