...
Son architecture entièrement basée sur les _Streams_ rend cette librairie particulièrement rapide et efficace pour les traitements de fichiers impliquant plusieurs étapes de transformation.
