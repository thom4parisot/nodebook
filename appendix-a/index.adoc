...
indexterm:[module npm, eventemitter3]
...
=== livereactload
indexterm:[module npm, livereactreload]
...
=== sanitize-filename
indexterm:[module npm, sanitize-filename]
...
indexterm:[Document Object Model (DOM)]
...
=== filenamify
indexterm:[module npm, filenamify]
indexterm:[module, path]
indexterm:[module, fs]
...
=== retire.js
indexterm:[module npm, retire.js]
indexterm:[npm, audit]
...
[[optimize]]
== Optimiser nos ressources{nbsp}web
indexterm:[application front-end, optimisation du code]
indexterm:[application front-end, optimisation d'image]

Commentaires dans le code, fonctions inutilisées ou images surdimensionnées :
autant d'octets transférés pour rien et qui pénalisent la navigation sur le web.

Les minifieurs et optimiseurs de code mettent en œuvre différentes techniques pour
réduire le poids de notre code sans compromettre sa lisibilité et sa maintenabilité :
...
=== uglify-es
indexterm:[module npm, uglify]
indexterm:[module npm, uglify-es]
...
=== autoprefixer
indexterm:[module npm, postcss]
indexterm:[module npm, autoprefixer]
indexterm:[module npm, browserlist]
...
=== sass
indexterm:[module npm, node-sass]
indexterm:[Sass]
...
.stylesheet.scss
----
include::{sourceDir}/stylesheet.scss[]
----

L'exécutable `sass` compile le fichier `.scss`:

----
$ ../node_modules/.bin/node-sass stylesheet.scss
----

=== postcss
indexterm:[module npm, postcss]

_PostCSS_ ([URL]#https://npmjs.com/postcss#) est une chaîne modulaire de transformation CSS.
...
=== less
indexterm:[module npm, less]
indexterm:[application front-end, optimisation du code]
indexterm:[Less]
indexterm:[Sass]

_less_ ([URL]#https://npmjs.com/less#) est un préprocesseur CSS dans la même lignée que Sass.
Il gère lui aussi des variables, des _mixins_, des calculs de couleurs et
des fonctions qui encouragent une écriture modulaire, plus logique et plus succincte.

Sass est devenu beaucoup plus populaire au fil du temps.
Less a toutefois l'avantage de fonctionner dans les navigateurs : compiler
une feuille de style sous Node et dans un navigateur retourne le même résultat !
...
indexterm:[typage]
indexterm:[ECMAScript, conversion]
indexterm:[module npm, typescript]
...
=== rimraf
indexterm:[module npm, rimraf]

Supprimer un répertoire et ce qu'il contient revient à lister ses fichiers,
les effacer un à un puis à supprimer les répertoires lorsqu'ils sont enfin vides.
_rimraf_ ([URL]#https://npmjs.com/rimraf#) masque cette complexité et supprime
une arborescence de manière récursive en une ligne de code.
...
=== graceful-fs
indexterm:[module npm, graceful-fs]
...
=== fs-extra
indexterm:[module npm, fs-extra]
indexterm:[module, fs]

_fs-extra_ ([URL]#https://npmjs.com/fs-extra#) est une collection
de fonctions pour qui simplifient des opérations courantes : créer plusieurs
répertoires d'un coup, créer l'arborescence nécessaire à l'écriture d'un fichier,
lecture et écriture de fichiers JSON.

Il se base sur <<graceful-fs,_graceful-fs_>> pour une meilleure gestion des
erreurs et des ressources. Son but est d'être un remplacement transparent
du module de base{nbsp}``fs``.

=== chokidar
indexterm:[module npm, chokidar]
...
=== db-migrate
indexterm:[module npm, db-migrate]
...
=== bookshelf
indexterm:[module npm, bookshelf]
...
=== sequelize
indexterm:[module npm, sequelize]
...
=== redis
indexterm:[module npm, redis]
indexterm:[module npm, hiredis]
...
=== elasticsearch
indexterm:[module npm, elasticsearch]
...
indexterm:[module npm, yargs-parser]
...
=== supports-color
indexterm:[module npm, supports-color]
...
indexterm:[module npm, express]
indexterm:[module npm, point-of-view]
...
=== passport
indexterm:[module npm, passport]
indexterm:[application web, authentification]
...
indexterm:[application web, API REST]
...
=== swagger-client
indexterm:[module npm, swagger-client]
...
=== storybook
indexterm:[module npm, storybook]
indexterm:[module npm, react]
...
== Tester notre code
indexterm:[test]
indexterm:[module, assert]

Le module de base `assert` combiné à la commande
<<../chapter-05/index.adoc#test,`npm{nbsp}test`>> suffisent pour démarrer.
Il existe tout un outillage complémentaire pour tester notre code, qu'il soit destiné
à fonctionner dans Node, dans un navigateur web ou les deux.
...
=== sinon
indexterm:[module npm, sinon]
indexterm:[module npm, sinon-chai]
indexterm:[module npm, chai]
indexterm:[test, espion]
indexterm:[test, stub]
indexterm:[test, mock]
...
=== nyc
indexterm:[module npm, nyc]
indexterm:[module npm, istanbul]
indexterm:[test, couverture]
...
=== karma
indexterm:[module npm, karma]
indexterm:[test, front-end (avec navigateur)]
...
=== supertest
indexterm:[module npm, supertest]
indexterm:[test, HTTP]
indexterm:[HTTP, test]
...
== Objets connectés
indexterm:[module npm, lodash]
indexterm:[microcontrôleur]
indexterm:[Arduino (voir microcontrôleur)]
...
=== serialport
indexterm:[module npm, serialport]
...
=== johnny-five
indexterm:[module npm, johnny-five]
...
== Accessibilité web
indexterm:[application front-end, accessibilité]
indexterm:[application front-end, optimisation de code]
indexterm:[test, automatisation]
...
=== lighthouse
indexterm:[module npm, lighthouse]
...
indexterm:[module npm, storybook]
indexterm:[module npm, storybook-addon-a11y]
