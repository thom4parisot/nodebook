...
[TIP]
.[RemarquePreTitre]#Question# Quelle base de données choisir ?
====
Nous avons répondu à cette question dans la section <<../chapter-03/index.adoc#database,choix d'une base de données>> au chapitre 3.
====
