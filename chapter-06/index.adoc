...
glitch
runkit pour des trucs rapides
bonus : observable pour niveau expert

[[deploy.sftp]]
=== En transférant des fichiers via SSH ou SFTP

winscp
filezilla
scp && ssh

tip : https://superuser.com/questions/821892/filezilla-can-i-run-a-remote-shell-command-via-filezilla-client
