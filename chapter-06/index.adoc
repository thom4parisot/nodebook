...
Ces services vont se baser sur des *conventions* ou des fichiers de *configuration* pour comprendre la typologie de notre application et l'intégrer automatiquement.
