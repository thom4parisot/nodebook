...
[URL]#https://gandi.net/hosting/simple#,"git, SSH ou API",-,5€/mois/app
[URL]#https://heroku.com#,git,oui,7$/mois/app
|===
...
image::images/heroku-addons.png[align="center",width="85%"]

Les plates-formes en tant que service sont facturées à l'heure consommée et peuvent être mis en _pause_.
Elles ont l'avantage d'être rapidement déployables, faciles à prendre en main et ne nécessitent que peu (voire pas) de connaissance en administration de machine informatique.

Le paiement à l'heure _et_ à l'instance peut rapidement saler l'addition et questionner l'utilisation de ce type de services en lieu et place d'un serveur dédié par exemple. +
