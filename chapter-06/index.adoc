...
Ces services vont se baser sur des *conventions* ou des fichiers de *configuration* pour comprendre la structure de notre application et déterminer de son intégration dans leur plate-forme.
