...
<!--
Ca mérite peut-être un peu plus d'explications, ou alors tu l'abordes après ?
-->
...
<!--
Sur la "désuétude", certains DevOps, adeptes de l'intégration continue, te diront que l'avantage de yuicompressor (ou de Closure Compiler), c'est aussi sont côté "exécutable packagé"... et que Grunt est encore trop imprévisible dans les erreurs qu'il lève.
-->
====
...
<!--
Upload ou téléversement ? Quel vocable vas-tu choisir ?
-->
...
<!--
JS implémente IEEE 754, donc les problématiques sont les mêmes qu'en C# ou en Java, non ?
-->
...
<!--
Qu'est qui est vérifié ? Le descripteur ou la ressource ? La tournure est ambiguë.
-->
