...
D'autres initiatives plus récentes comme _APE_ (_Ajax Push Engine_, [URL]#http://ape-project.org/#) ont mis en œuvre JavaScript côté serveur. JavaScript était surtout un choix logique de partage de code entre client et serveur pour Comet, le précurseur des Websockets.
...
_yuicompressor_ a été surpassé par _Closure Compiler_ ([URL]#https://developers.google.com/closure/compiler/#) et _UglifyJS_ (https://npmjs.com/uglify-js#).
...
En 2013, _Nodejitsu_ lance l'initiative controversée _#scalenpm_ visant à collecter des fonds pour améliorer la performance et la stabilité du _registre npm_ ([URL]#https://www.npmjs.com/#). +
