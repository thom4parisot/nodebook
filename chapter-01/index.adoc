...
Rhino est également employé dans https://yui.github.io/yuicompressor/[yuicompressor], un optimiseur CSS et JavaScript créé par Yahoo.
...
En 2013, _Nodejitsu_ lance l'initiative controversée _#scalenpm_ visant à collecter des fonds pour améliorer la performance et la stabilité du registre https://www.npmjs.com/[npmjs.com]. +
...
Nous en parlerons plus en détail les modules développés par la _Node Security Platform_ et leur inclusion dans un cycle de vie projet dans le <<../chapter-07/index.adoc,Chapitre 7>>.
