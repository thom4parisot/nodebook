...
En 2015, après avoir traversé des périodes incertaines, l'avenir de Node est au beau fixe avec plus de 700 contributeurs à la plateforme et plus de 190 000 paquets publics hébergés par le registre _npm_.
