...
<2> Génère une exception — elle ne sera pas intercepée par la fonction `logErr()` située sur la même ligne ;
...
Le temps d'exécution total correspond à celui de la plus lente promesse..
