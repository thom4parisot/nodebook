...
Son architecture est entièrement basée sur les _Streams_ rend cette bibliothèque particulièrement efficace pour les traitements de fichiers impliquant plusieurs transformations.
