...
unicode (`u`)::
  À utiliser si le motif de recherche contient des caractères Unicode.
...
----
<1> identifie le `Node` de `Node.js` — la recherche insensible à la casse ;
<2> on combine deux options — `g` retourne _toutes_ les occurences.
