...
.Résultats obsolètes issue de `npm outdated`
image::images/npm-outdated-uptodate.png.png[align="center",scaledwidth="85%"]
...
En cas d'incompatibilité du client, la bibliothèque propose des solutions alternatives (Flash, JSONP, AJAX).
