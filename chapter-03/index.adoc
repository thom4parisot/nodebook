...
Ne vous fiez pas nécessairement à l'API mise à disposition par les modules employés mais vérifiez bien qu'elles emploient un minimum d'instructions non-bloquantes. +
...
[CAUTION]
.[RemarquePreTitre]#Attention# `try/catch` et callbacks
====
TBD.
====
