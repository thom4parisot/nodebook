...
Rare sont les cas où on choisira ce type de données par nous-même.
...
Une fonction peut _retourner_ un résultat de manière explicite avec le
mot-clé `return`.
Si une fonction ne retourne aucun résultat, ECMAScript considère
