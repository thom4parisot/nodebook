...
Et plus encore, on doit activement essayer de faire la distinction entre un résultat attendu d'une valeur _fausse_ et un résultat issu d'une erreur (système surchargé, fichier inexistant, lecture interrompu, _timeout_ etc.).
