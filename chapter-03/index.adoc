...
- *peerDependencies* : module dont l'installation vous est recommandée ; pratique couramment employée dans le cas de _plugins_. +
...
- https://npmjs.com/yo
- https://npmjs.com/express-generator
=====
...
----
node src/snippets/config-argv.js -y 2014 2012 --title 'fromage baguette' #<1>
----
...
- [URL]#http://doc.ubuntu-fr.org/upstart# (en français)
...
Compatible Node et navigateurs Web. +
[URL]#https://npmjs.com/eventemitter2#

[source,javascript]
.npm-eventemitter3.js
----
include::{sourceDir}/snippets/npm-eventemitter3.js[]
----
...
.npm-babel.js
----
include::{sourceDir}/snippets/npm-babel.js[]
----
...
[URL]#https://npmjs.com/jshint# et [URL]#https://npmjs.com/eslint#
